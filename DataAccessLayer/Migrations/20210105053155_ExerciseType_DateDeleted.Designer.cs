...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20210105053155_ExerciseType_DateDeleted")]
    partial class ExerciseType_DateDeleted
    {
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Eating", b =>
                {
                    ...
                    b.Property<Guid?>("InsulinTypeId1")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.Eating", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Models.InsulinType", null)
                        .WithMany("BasalUsers")
                        .HasForeignKey("InsulinTypeId");

                    b.HasOne("DataAccessLayer.Models.InsulinType", null)
                        .WithMany("BolusUsers")
                        .HasForeignKey("InsulinTypeId1");
